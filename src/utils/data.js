...
const projects = [
    {
        ...
        description: ['iCARE or iTamaraw Center for Academic Resources and Enrichment is a department in FEU Tech where students can book consultations with their professors and schedule tutorials with professors and/or students. iCARE also provides enhancement classes to help students pass their upcoming exams or tests.','The unofficial iCARE Website, originally developed in PHP as a final project for Data Structures & Algorithms which I completely rewrote using the MERN stack.', 'The frontend is written in React.js and styled using Tailwind CSS, while the backend is powered by MongoDB, Express, and Node.js. The web application allows students students to book consultations and tutorials with professors.'
        ]
    },
    {
        id: '2',
    ...
    },
    {
        ...
        description: [
            "My thesis projet, POULTRYGUARD is a heat stress monitoring system designed for poultry farms, utilizing real-time data collection and computer vision to detect heat stress in chickens. It enables farmers to take proactive measures to maintain livestock health and welfare.", "The system features a fine-tuned YOLOv8n model for chicken detection, thermal imaging for temperature monitoring, and automated alerts when heat stress levels become critical. Additionally, a microcontroller-controlled cooling system is integrated to regulate farm conditions.", "Team members: Julian Cadenas, Joshua Cormier, Christian Javier, Daryl Guerzon."
        ]
    },
    {
        id: '11',
        ...
        description: ["This project uses a fine-tuned version of the BART model from Facebook for summarizing Reddit posts and their comments. The original model, facebook/bart-large-cnn, is a pre-trained sequence-to-sequence model optimized for summarization tasks. For this project, it was further fine-tuned on a custom Reddit dataset.", "The model's performance was evaluated using BERTScore, ROUGE & METEOR, showcasing decent performance.", "This project is still under development, with ongoing improvements to enhance its performance further."]
    },
    {
        id: '12',
        category: 'aiml',
        ...
        description: ["AI-CLI is a command-line application that allows users to interact with LLMs directly from their terminal.", "The CLI leverages Typer and Rich to enhance terminal output, formatting code and markdown responses for better readability. Currently, it supports LLAMA 3.", "The project is fully functional but remains under development to refine output formatting, prompt handling, and overall user experience."]
    },
];
